...
export interface DataStore {
  ...
  saveTextbookChunks(userId: string, textbookId: string, chunks: TextbookChunk[]): Promise<void>;
  getTextbookChunks(userId: string, textbookId: string): Promise<TextbookChunk[]>;
}
