    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-slate-900">Academic Writing Evaluation</h1>
        ...
        <div className="lg:col-span-5 space-y-4">
          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
            ...
            {activeTaskData.htmlContent ? (
              ...
              <div className="text-xs text-slate-700 bg-slate-50 p-4 rounded-xl border border-slate-100 whitespace-pre-line leading-relaxed font-normal">
                {activeTaskData.prompt}
              </div>
            )}
          ...
          <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm space-y-4">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 pb-3 border-b border-slate-100">
              ...
              <div className="flex items-center space-x-3">
                ...
                {isUnderLength && (
                  <span className="text-[11px] text-amber-600 flex items-center space-x-1 font-medium">
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="text-xs px-2.5 py-1 rounded-md border border-slate-200 hover:bg-slate-50 text-slate-600 font-semibold"
                >
            ...
            <textarea
              ...
              className="w-full p-4 rounded-xl border border-slate-200 text-slate-900 text-sm font-sans leading-relaxed focus:outline-none focus:ring-2 focus:ring-slate-900 resize-y"
            />
      ...
      {result && (
        <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-lg space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-6 border-b border-slate-100 gap-4">
            ...
            <div className="flex items-center space-x-4 bg-slate-50 p-4 rounded-2xl border border-slate-200 shrink-0">
              <div className="text-right">
                ...
                <div className="text-xs text-slate-400 font-mono">{result.word_count} words</div>
              </div>
          ...
          <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 text-xs text-slate-800 leading-relaxed">
            <span className="font-bold text-slate-900">Examiner Summary: </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {result.criteria.map((crit, idx) => (
              <div
                key={crit.name || idx}
                className="p-4 rounded-xl border border-slate-200 bg-white space-y-2.5 shadow-sm"
              >
                <div className="flex items-center justify-between">
                ...
                {crit.improvement_tips && crit.improvement_tips.length > 0 && (
                  <div className="pt-2 border-t border-slate-100">
                    <div className="text-[11px] font-bold text-amber-700 mb-1">To reach next band:</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {result.annotated_text.map((ann, aIdx) => (
                  ...
                  >
                    ...
                    <div className="text-xs font-serif text-slate-800 bg-rose-50/50 p-1.5 rounded border border-rose-100 mb-2">
                      "{ann.span}"
                    </div>

                    <div className="text-xs text-slate-600 mb-2">{ann.comment}</div>

                    <div className="text-xs font-semibold text-emerald-800 bg-emerald-50 p-2 rounded-lg border border-emerald-200 flex items-center space-x-1.5">
