  ...
  return (
    <div className="space-y-6">
        ...
        {audioUrl && (
          <div className="p-3 bg-indigo-50 border border-indigo-200 rounded-xl flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs font-bold text-indigo-900">Audio Linked: {audioFileName || 'Uploaded Track'}</span>
            </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div>
          <label className="block text-xs font-bold text-slate-700 mb-1">Section Test Title</label>
          <input
            type="text"
            value={title}
        ...
        <div>
          <label className="block text-xs font-bold text-slate-700 mb-1">Theme / Context</label>
          <input
            type="text"
            value={theme}
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <label className="block text-xs font-bold text-slate-700">Audio Transcript (Teacher/Examiner Mode)</label>
        ...
        <textarea
          ...
          className="w-full text-xs p-3 font-mono leading-relaxed bg-slate-50 border border-slate-200 rounded-xl"
