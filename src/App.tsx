      ...
      <footer className="bg-white border-t border-slate-200 mt-12 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-3 text-center sm:text-left">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="text-xs text-slate-500 font-medium">Single-User Private Architecture • Local & Cloud Storage • Zero Third-Party Tracking</div>
          </div>
          <p className="text-[11px] text-slate-400 leading-relaxed max-w-4xl">IELTS® is a registered trademark of University of Cambridge, British Council, and IDP Education Australia. This application is an independent educational tool designed exclusively for personal non-commercial study. All academic passages, listening dialogues, questions, and cue cards are original synthetic materials crafted for skill mastery and are not affiliated with or endorsed by Cambridge, British Council, or IDP.</p>
        </div>
      </footer>
