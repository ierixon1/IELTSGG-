...
export const en: Dictionary = {
  ...
  plan: {
    ...
    focusFromResults: 'diagnosed from your results',
    focusSelfAssessed: 'your own assessment',
  ...
  speaking: {
    ...
    fileTooLarge: 'That file is over {limit} MB. Trim the recording or export it at a lower quality.',
    ...
    result: {
      ...
      uploadedNote: 'Duration comes from the file and pace from the transcript. Pause data needs a live recording, so it is not shown.',
      ...
      coverageTitle: 'Cue card points',
      coverageNote: 'A checklist, not a band — IELTS Speaking is marked on four criteria only.',
      covered: 'Covered',
  ...
  writing: {
    ...
    rewrite: {
      pitch: 'See your longest paragraph rewritten at a higher band, with every edit explained.',
      action: 'Rewrite at Band 8',
      working: 'Rewriting…',
      title: 'Your paragraph at Band {band}',
      note: 'Your argument and examples kept — only the language changed',
  ...
  exam: {
    ...
    lockdown: 'Your progress is saved as you go. The clock keeps running if you leave the page or reload it.',
    abort: 'Abort',
    abortConfirm: 'Leave this exam? The sitting ends here and no result is recorded for it.',
    ...
    chooseEyebrow: 'Full exam',
    chooseTitle: 'Choose a published exam',
    chooseSubtitle: 'Each exam runs Listening, Reading, Writing and Speaking in that order, timed as its administrator configured it.',
    loadingList: 'Loading exams…',
    noExams: 'No exam has been published yet.',
    listError: 'The list of exams could not be loaded.',
    parts: 'Listening: {listening} parts · Reading: {reading} passages · Writing: Tasks 1 and 2 · Speaking: Parts 1–3',
    totalMinutes: '{minutes} min in total',
    timingReference: 'IELTS reference timing',
    timingCustom: 'Custom timing set by the administrator',
    unavailable: 'Not available right now',
    open: 'Open this exam',
    opening: 'Opening…',
    readyTitle: 'Before you start',
    readyBody: 'The sections run back to back. When a section’s time runs out it closes on the answers you have given; Writing and Speaking count only when every task and part has been graded.',
    sectionMinutes: '{name}: {minutes} min',
    earlyFinishAllowed: 'You may finish a section early once its content is complete.',
    earlyFinishLocked: 'Each section stays open until its time is up.',
    start: 'Start the exam',
    timeLeft: 'Time left in this section',
    finishSection: 'Finish {name}',
    finishBlocked: 'To finish this section: {items}.',
    missingAnswers: 'submit your answers',
    ...
    sectionExpired: 'Time ran out',
    back: 'Back to exams',
    resume: 'Resume this exam',
    inProgress: 'In progress',
    resumedNotice: 'You are back where you left off. Your saved answers are restored; the clock kept running while you were away.',
    saveError: 'Your last change was not saved ({message}). It will be sent again with your next change.',
    attemptSaved: 'This result is saved to your record.',
    attemptNotSaved: 'This result has not been saved yet.',
    retrySave: 'Try saving again',
    errors: {
      bundle_not_found: { title: 'Exam not found', body: 'This exam does not exist. It may have been removed; choose another one.' },
      bundle_unpublished: { title: 'Exam withdrawn', body: 'An administrator has withdrawn this exam, so it cannot be sat right now.' },
      bundle_archived: { title: 'Exam retired', body: 'This exam has been retired and can no longer be sat.' },
      component_missing: { title: 'Part of the exam is missing', body: 'The exam refers to material that no longer exists. Nothing has been substituted; an administrator needs to fix the exam.' },
      component_unpublished: { title: 'Part of the exam was withdrawn', body: 'Material this exam uses is no longer published. Nothing has been substituted; an administrator needs to fix the exam.' },
      component_changed: { title: 'The exam has changed', body: 'Material in this exam was edited after the exam was published, so it has to be checked again before anyone sits it.' },
      asset_unavailable: { title: 'A file is unavailable', body: 'A file this exam needs, such as the Listening audio, is missing. The exam does not run without it.' },
      invalid_bundle: { title: 'Exam not configured correctly', body: 'This exam is not set up in a way that can be sat. An administrator needs to fix it.' },
      unauthorized: { title: 'Sign in required', body: 'Sign in to sit this exam.' },
      network: { title: 'Server not reachable', body: 'The exam could not be loaded. Check your connection and try again.' },
      session_superseded: { title: 'The exam was republished', body: 'This exam was changed and published again while you were sitting it, so this sitting cannot continue. Open the exam again to start the current version.' },
      session_closed: { title: 'This sitting has ended', body: 'You left this sitting, so it cannot be resumed. Open the exam again to start a new one.' },
    },
  },
  ...
  grading: {
    errors: {
      ...
      quota_exceeded: 'The AI grading allowance for now is used up. Your answer is still here — try again later.',
      grading_timeout: 'Grading took too long and was stopped. Your answer is still here — try again.',
      already_submitted: 'This was already submitted, with a different answer. The submitted one is kept.',
      section_closed: 'Time for this section is up, so nothing more can be submitted in it.',
    ...
    exam: {
      ...
      failed: '{item} is submitted and kept, but grading did not finish: {reason}.',
      retry: 'Try grading again',
      final: 'No grading attempts are left for this answer, so it has no band.',
      reason: {
        unavailable: 'the grading model was unavailable',
        timeout: 'it took too long',
        quota: 'the AI grading allowance is used up for now',
        failed: 'the grader could not assess it',
      },
      resultTitle: 'Your exam is over',
      resultBody: 'Every section was handed in. The overall band appears once the remaining answers are graded.',
      resultUngradedBody: 'Every section was handed in, but some answers could not be graded, so no overall band is given. Your answers are kept.',
      outstandingTitle: 'Some answers are still being graded',
      outstandingBody: 'Your answers are kept. This page updates by itself as bands arrive.',
      item: {
        writing: 'Writing Task {n}',
        speaking: 'Speaking Part {n}',
      },
    },
  },
