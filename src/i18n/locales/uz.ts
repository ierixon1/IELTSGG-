...
export const uz: Dictionary = {
  ...
  grading: {
    errors: {
      ...
      quota_exceeded: 'AI baholash limiti hozircha tugadi. Javobingiz saqlanib turibdi — keyinroq urinib ko‘ring.',
      grading_timeout: 'Baholash juda uzoq davom etdi va to‘xtatildi. Javobingiz saqlanib turibdi — qaytadan urinib ko‘ring.',
      already_submitted: 'Bu allaqachon boshqa javob bilan topshirilgan. Topshirilgan javob saqlanadi.',
      section_closed: 'Bu bo‘lim vaqti tugadi, unda boshqa hech narsa topshirib bo‘lmaydi.',
    ...
    exam: {
      ...
      failed: '{item} topshirildi va saqlandi, lekin baholash tugamadi: {reason}.',
      retry: 'Qayta baholash',
      final: 'Bu javobni baholash urinishlari qolmadi, shuning uchun unga ball yo‘q.',
      reason: {
        unavailable: 'baholash modeli mavjud emas edi',
        timeout: 'juda uzoq davom etdi',
        quota: 'AI baholash limiti hozircha tugagan',
        failed: 'baholovchi javobni baholay olmadi',
      },
      resultTitle: 'Imtihon tugadi',
      resultBody: 'Barcha bo‘limlar topshirildi. Umumiy ball qolgan javoblar baholangach chiqadi.',
      resultUngradedBody: 'Barcha bo‘limlar topshirildi, lekin ba’zi javoblarni baholab bo‘lmadi, shuning uchun umumiy ball qo‘yilmaydi. Javoblaringiz saqlangan.',
      outstandingTitle: 'Ba’zi javoblar hali baholanmoqda',
      outstandingBody: 'Javoblaringiz saqlangan. Ballar chiqqanda sahifa o‘zi yangilanadi.',
      item: {
        writing: 'Writing, {n}-topshiriq',
        speaking: 'Speaking, {n}-qism',
      },
    },
  },
