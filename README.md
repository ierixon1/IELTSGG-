...
Production must keep EXPLICIT_DEV_AUTH=false and SEED_DEFAULT_ACCOUNTS=false unless controlled bootstrap is explicitly required. Production must provide valid Google/Firebase credentials and use STORAGE_BACKEND=gcs_firestore.
